...
#ifndef LIBCORAL_CORAL_PIPELINE_INTERNAL_THREAD_SAFE_QUEUE_H_
#define LIBCORAL_CORAL_PIPELINE_INTERNAL_THREAD_SAFE_QUEUE_H_
...
#endif  // LIBCORAL_CORAL_PIPELINE_INTERNAL_THREAD_SAFE_QUEUE_H_
