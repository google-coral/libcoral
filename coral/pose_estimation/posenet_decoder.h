...
#ifndef LIBCORAL_CORAL_POSE_ESTIMATION_POSENET_DECODER_H_
#define LIBCORAL_CORAL_POSE_ESTIMATION_POSENET_DECODER_H_
...
#endif  // LIBCORAL_CORAL_POSE_ESTIMATION_POSENET_DECODER_H_
